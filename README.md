...
- If you want to get started by doing some fun Arduino projects from this class and/or the [Arduino Class](https://github.com/Mark-MDO47/ArduinoClass "Arduino Class") you can skim (or temporarily skip) the standard C and C++ methods, knowing that they are not used for these projects. You can return to the standard methods later.
